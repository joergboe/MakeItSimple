...
# Requires Makefile5-auto-headers.mk for header unit translation.
...
clean-user-header-units :
	$(MAKE) -f Makefile5-auto-headers.mk KIND=USER clean
	@echo

.PHONY : clean-system-header-units
clean-system-header-units :
	$(MAKE) -f Makefile5-auto-headers.mk KIND=SYSTEM clean
	@echo

# remove all generated artifacts
.PHONY : purge
purge : clean-header-units clean
	$(MAKE) -f Makefile5-auto-headers.mk KIND=USER purge
	$(MAKE) -f Makefile5-auto-headers.mk KIND=SYSTEM purge
	rm -fv *.d
	rm -fv *.ddi
	rm -fv *.ddi2
	rm -fv *.dep
